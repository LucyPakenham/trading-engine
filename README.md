...
```bash
python -m streamlit run week7.py
```
...
- C++ performance core with Python ctypes bindings — 1.4x speedup
- Risk analytics — Sharpe ratio, VaR (historical and Monte Carlo), max drawdown
